...
CREATE TABLE `season` (
  ...
  `nomeSeason` varchar(31) NOT NULL,
  `inicioVigencia` date NOT NULL,
  `fimVigencia` date NOT NULL,
  `idTabuleiro` int NOT NULL,
  `prioridade` tinyint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idTabuleiro` (`idTabuleiro`),
  CONSTRAINT `season_ibfk_1` FOREIGN KEY (`idTabuleiro`) REFERENCES `tabuleiro` (`id`)
...
-- Dump completed on 2024-01-19  9:45:33
